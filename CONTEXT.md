...
- **Mika**: what I named the Hermes agent in Multica (its project-lead
  persona). Mika runs the *host* Hermes install (`~/.hermes`), which sandboxes
  each task in its own podman container.
